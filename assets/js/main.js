...
var work__tab = document.getElementById('work__tab');
work.style.visibility = 'hidden';
work__tab.onclick = function(){
...
/*==================== PORTFOLIO VIEW ====================*/
let view_Demoi = document.getElementById('view_Demo1');
let view_Demoii = document.getElementById('view_Demo2');
...
view_Demoi.onclick = function(){
    mainDis.style.visibility = 'visible';
    document.getElementById('view_IMG').src = 'assets/img/HTML.jpeg';
}
view_Demoii.onclick = function(){
    mainDis.style.visibility = 'visible';
    document.getElementById('view_IMG').src = 'assets/img/CSS.jpeg';
}
